import{_ as M}from"./iframe-79fb2b3d.js";import{d as Q,f as W,o as p,e as g,g as X,n as Y,j as Z,k as x,u as h,l as b,m as ee,p as oe,q as te}from"./vue.esm-bundler-2c1b5ed0.js";import"../sb-preview/runtime.js";const K=Q({__name:"Button",props:{href:{},status:{},outline:{type:Boolean},icon:{},disabled:{type:Boolean}},setup(f){const t=oe(()=>M(()=>import("./Icon-6c030a7e.js"),["./Icon-6c030a7e.js","./vue.esm-bundler-2c1b5ed0.js"],import.meta.url)),s=W(()=>{const e=te().default;let o="";return e().forEach(n=>o+=n.children),o});return(e,o)=>{var n,k,y,C;return p(),g(x(e.href?"a":"button"),{href:e.href,class:Y(["btn",{"btn--status":e.status,"btn--icon-only":((n=e.icon)==null?void 0:n.position)==="icon-only","btn--icon-before":((k=e.icon)==null?void 0:k.position)==="before-text","btn--icon-after":((y=e.icon)==null?void 0:y.position)==="after-text"}]),title:((C=e.icon)==null?void 0:C.position)==="icon-only"?s.value:void 0,style:Z(e.status?e.outline?`
