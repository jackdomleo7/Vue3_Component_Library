...
- `text-xs`: <span style={{fontSize: '0.75rem'}}>0.75rem</span>
- `text-sm`: <span style={{fontSize: '0.875rem'}}>0.875rem</span>
- `text-md`: <span style={{fontSize: '1rem'}}>1rem</span>
- `text-lg`: <span style={{fontSize: '1.125rem'}}>1.125rem</span>
- `text-xl`: <span style={{fontSize: '1.25rem'}}>1.25rem</span>
- `text-xxl`: <span style={{fontSize: '1.5rem'}}>1.5rem</span>
